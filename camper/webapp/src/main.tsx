...
// draft states). Adding a new named color anywhere
// in the app needs a matching import here, or that color's tokens
// (e.g. --red-9) resolve to nothing.
...
import { installSlowNetwork } from './lib/slowNetwork';
