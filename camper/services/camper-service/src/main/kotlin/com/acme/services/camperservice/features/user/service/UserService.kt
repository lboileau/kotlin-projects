...
class UserService(userClient: UserClient) {
    ...
    /** Generate a random avatar preview without persisting. */
    fun randomizeAvatar(param: RandomizeAvatarParam): Result<AvatarPreviewResponse, UserError> = randomizeAvatarAction.execute(param)
