...
internal class ValidateDeleteGearPack {
    private val logger = LoggerFactory.getLogger(ValidateDeleteGearPack::class.java)
    ...
    private fun validate(param: DeleteGearPackParam): Result<Unit, GearPackError> {
        return success(Unit)
    }
}
