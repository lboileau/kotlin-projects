...
internal class ValidateDeleteJournalEntry {
    private val logger = LoggerFactory.getLogger(ValidateDeleteJournalEntry::class.java)
    ...
    private fun validate(@Suppress("UNUSED_PARAMETER") param: DeleteJournalEntryParam): Result<Unit, LogBookError> {
        return success(Unit)
    }
}
