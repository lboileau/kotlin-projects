...
dependencies {
    ...
    implementation(project(":clients:gear-pack-client"))
    ...
    implementation(project(":clients:photo-storage-client"))
    ...
    testImplementation(testFixtures(project(":clients:gear-pack-client")))
    ...
    testImplementation(testFixtures(project(":clients:photo-storage-client")))
