# interview-manager-db

PostgreSQL database module for the Interview Manager project. This is a Gradle module that exposes a `MigrationRunner` utility class (`com.acmo.databases.interviewmanagerdb.MigrationRunner`) for running migrations programmatically.
...
- Host: `localhost`
- Port: `5433`
- Database: `interview_manager_db`
- User: `postgres`
- Password: `postgres`
- JDBC URL: `jdbc:postgresql://localhost:5433/interview_manager_db`

## Relationships

No foreign key relationships yet (single table).
